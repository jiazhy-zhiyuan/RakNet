...
int RakNet::ReadyEvent::RemoteSystemCompByGuid(const RakNetGUID &key,
...
RakNetGUID ReadyEvent::GetFromWaitListAtIndex(int eventId,
...
PluginReceiveResult ReadyEvent::OnReceive(Packet *packet) {
  ...
  switch (packetIdentifier) {
    ...
    case ID_READY_EVENT_ALL_SET:
      //		if (doPrint) {if
      //(packet->systemAddress.GetPort()==60002)
