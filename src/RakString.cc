...
RakNet::RakString RakString::FormatForPUTOrPost(const char *type,
                                                const char *uri,
...
RakString RakString::FormatForPOST(const char *uri, const char *contentType,
                                   const char *body, const char *extraHeaders) {
  return FormatForPUTOrPost("POST", uri, contentType, body, extraHeaders);
}
RakString RakString::FormatForPUT(const char *uri, const char *contentType,
                                  const char *body, const char *extraHeaders) {
