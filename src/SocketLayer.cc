...
void SocketLayer::SetSocketOptions(__UDPSOCKET__ listenSocket,
                                   bool blockingSocket, bool setBroadcast) {
...
void SocketLayer::GetSystemAddress_Old(__UDPSOCKET__ s,
...
*/
void SocketLayer::GetSystemAddress(__UDPSOCKET__ s,
                                   SystemAddress *systemAddressOut) {
#if RAKNET_SUPPORT_IPV6 != 1
