...
class RAK_DLL_EXPORT IncrementalReadInterface {
 public:
  ...
  /// from \param[in] numBytesToRead How many bytes to read. This is also how
  /// many bytes have been allocated to preallocatedDestination \param[out]
  /// preallocatedDestination Write your data here \return The number of bytes
  /// read, or 0 if none
