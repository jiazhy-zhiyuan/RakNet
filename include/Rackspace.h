...
/// Rackspace API servers \pre Compile RakNet with OPEN_SSL_CLIENT_SUPPORT set
/// to 1 \pre Packets returned from TCPInterface::OnReceive() must be passed to
/// Rackspace::OnReceive() \pre Packets returned from
/// TCPInterface::HasLostConnection() must be passed to
...
class RAK_DLL_EXPORT Rackspace {
 public:
  ...
  /// commands. \details All requests to authenticate and operate against Cloud
  /// Servers are performed using SSL over HTTP (HTTPS) on TCP port 443. Times
  /// out after 24 hours - if you get RET_Authenticate_Unauthorized in the
  /// RackspaceEventCallback callback, call again \sa
  /// RackspaceEventCallback::OnAuthenticationResult() \param[in] _tcpInterface
  /// An instance of TCPInterface, build with OPEN_SSL_CLIENT_SUPPORT 1 and
  /// already started \param[in] _authenticationURL See
  ...
  /// on their website \param[in] _apiAccessKey Obtain your API access key from
  /// the Rackspace Cloud Control Panel in the Your Account API Access section.
  ...
  /// GetServerDetails() is returned in the field <server ... id="1234"> \sa
  /// http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf
  ...
  /// hyphen. \param[in] imageId Which image (harddrive contents, including OS)
  /// to use \param[in] flavorId Which flavor (hardware config) to use,
  /// primarily how much memory is available.
  ...
  /// \param[in] serverId Which server to get details on. You can call
  /// ListServers() to get the list of active servers. \param[in] newName The
  /// new server name. Leave blank to leave unchanged. Only alphanumeric
  /// characters, periods, and hyphens are valid. Server Name cannot start or
  /// end with a period or hyphen. \param[in] newPassword The new server
  ...
  /// \param[in] serverId Which server to operate on. You can call ListServers()
  /// to get the list of active servers. \param[in] ipAddress Which IP address.
  /// You can call ListServerAddresses() to get the list of addresses for the
  /// specified server
  ...
  /// \param[in] serverId Which server to operate on. You can call ListServers()
  /// to get the list of active servers. \param[in] rebootType Should be either
  /// "HARD" or "SOFT"
  ...
  /// \param[in] serverId Which server to operate on. You can call ListServers()
  /// to get the list of active servers. \param[in] imageId Which image
  /// (harddrive contents, including OS) to use
  ...
  /// effect until you call ConfirmResizedServer() \sa
  /// http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf
  /// \sa RackspaceEventCallback::OnResizeServerResult()
  /// \sa RevertResizedServer()
  /// \param[in] serverId Which server to operate on. You can call ListServers()
  /// to get the list of active servers. \param[in] flavorId Which flavor
  /// (hardware config) to use, primarily how much memory is available.
  ...
  /// which includes images you create yourself \sa
  /// http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf
  ...
  /// lets you start a server with the same harddrive contents later \sa
  /// http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf
  /// \sa RackspaceEventCallback::OnCreateImageResult()
  /// \sa ListImages()
  /// \param[in] serverId Which server to operate on. You can call ListServers()
  /// to get the list of active servers. \param[in] imageName What to call this
  /// image
