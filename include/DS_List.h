...
class RAK_DLL_EXPORT List {
 public:
  ...
  /// the capacity of the list and fill slot with @em filler. \param[in] input
  /// The element to replace at position @em position. \param[in] filler The
  /// element use to fill new allocated capacity. \param[in] position The
  /// position of input in the list.
  ...
  /// matter \param[in] position The index of the element to delete
  ...
  /// found. \param[in] input The element to check for \return The index or
  /// position of @em input in the list. \retval MAX_UNSIGNED_LONG The object is
  /// not in the list \retval [Integer] The index of the element in the list
