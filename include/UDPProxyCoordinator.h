...
/// coordinator will relay our forwarding request \brief Middleman between
/// UDPProxyServer and UDPProxyClient, maintaining a list of UDPProxyServer, and
/// managing state for clients to find an available forwarding server. \ingroup
...
class RAK_DLL_EXPORT UDPProxyCoordinator : public PluginInterface2 {
 public:
  ...
  struct ForwardingRequest {
    ...
    SystemAddress requestingAddress;  // Which system originally sent the
                                      // network message to start forwarding
