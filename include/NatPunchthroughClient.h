...
/// another client once ports are estimated. \sa NatTypeDetectionClient See also
...
class RAK_DLL_EXPORT NatPunchthroughClient : public PluginInterface2 {
 public:
  ...
  /// will speed up the process \param[in] destination The system to punch. Must
  ...
  /// \a facilitator \param[in] facilitator A system we are already connected to
  /// running the NatPunchthroughServer plugin \sa OpenNATGroup() You will get
  /// ID_NAT_PUNCHTHROUGH_SUCCEEDED on success You will get
