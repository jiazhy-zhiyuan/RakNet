...
class RAK_DLL_EXPORT RakString {
 public:
  ...
  /// previous locations. \param[in] stringToFind The string to find inside of
  /// this object's string \param[in] pos The position in the string to start
  /// the search \return Returns the position of the first occurrence in the
  /// string.
  ...
  static RakNet::RakString FormatForPOST(const char *uri,
  ...
  /// masterserver2.raknet.com/testServer?__gameId=comprehensivePCGame \return
  /// Formatted string
  static RakNet::RakString FormatForGET(const char *uri,
                                        const char *extraHeaders = "");
  ...
  /// \return Formatted string
  static RakNet::RakString FormatForDELETE(const char *uri,
                                           const char *extraHeaders = "");
  ...
  /// variable in the stream (saves bandwidth) \pre
  /// StringCompressor::AddReference must have been called to instantiate the
  ...
  /// the data stream. Must match what was passed to SerializeCompressed \return
  /// true if the deserialization was successful \pre
  /// StringCompressor::AddReference must have been called to instantiate the
  /// class (Happens automatically from RakPeer::Startup())
