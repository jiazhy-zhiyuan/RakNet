...
class RAK_DLL_EXPORT EmailSender {
 public:
  ...
  /// to send none). \param[in] doPrintf true to output SMTP info to console(for
  /// debugging?) \param[in] password Used if the server uses AUTHENTICATE PLAIN
  /// over TLS (such as gmail) \return 0 on success, otherwise a string
