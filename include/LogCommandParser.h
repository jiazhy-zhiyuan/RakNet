...
class RAK_DLL_EXPORT LogCommandParser : public CommandParserInterface {
 public:
  ...
  /// you wish. \param[in] command The command to process \param[in]
  ...
  /// parser to \a systemAddress \param[in] transport The transport interface we
  /// can use to write to \param[in] systemAddress The player that requested
  /// help.
  ...
  /// at the time you write will get the output. \param[in] format Same as
  /// RAKNET_DEBUG_PRINTF() \param[in] ... Same as RAKNET_DEBUG_PRINTF()
  ...
  /// or forcefully \param[in] systemAddress The player that has disconnected.
  /// \param[in] transport The transport interface that sent us this
  /// information.
  ...
  /// it \param[in] transport The new TransportInterface
 ...
 protected:
  ...
  /// \param[in] channelName If 0, then unsubscribe from all channels.
  /// Otherwise unsubscribe from the named channel
  ...
  /// is located \param[in] channelName The name of the channel
