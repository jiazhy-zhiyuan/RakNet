...
/// to a file if you override it and give it this functionality. \ingroup
/// PACKETLOGGER_GROUP
class RAK_DLL_EXPORT PacketLogger : public PluginInterface2 {
 public:
  ...
  virtual void FormatLine(char* into, const char* dir, const char* type,
                          ...
                          unsigned int frame, unsigned char messageIdentifier,
                          const BitSize_t bitLen, unsigned long long time,
