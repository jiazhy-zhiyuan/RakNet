...
class RakNetSocket2 {
 public:
  ...
  virtual RNS2SendResult Send(RNS2_SendParameters *sendParameters,
...
class RNS2_WindowsStore8 : public RakNetSocket2 {
 public:
  ...
  static int WinRTSetSockOpt(Windows::Networking::Sockets::DatagramSocket ^ s,
                             int level, int optname, const char *optval,
                             socklen_t optlen);
...
class RNS2_NativeClient : public RakNetSocket2 {
 public:
  ...
  RNS2BindResult Bind(NativeClientBindParameters *bindParameters,
                      const char *file, unsigned int line);
  RNS2SendResult Send(RNS2_SendParameters *sendParameters, const char *file,
                      unsigned int line);
 ...
 protected:
  ...
  void BufferSend(RNS2_SendParameters *sendParameters, const char *file,
                  unsigned int line);
...
class IRNS2_Berkley : public RakNetSocket2 {
 public:
  ...
  // ----------- MEMBERS ------------
  virtual RNS2BindResult Bind(RNS2_BerkleyBindParameters *bindParameters,
                              const char *file, unsigned int line) = 0;
};
...
class RNS2_Berkley : public IRNS2_Berkley {
 ...
 protected:
  ...
  static void GetSystemAddressIPV4(RNS2Socket rns2Socket,
                                   SystemAddress *systemAddressOut);
  static void GetSystemAddressIPV4And6(RNS2Socket rns2Socket,
                                       SystemAddress *systemAddressOut);
...
class RNS2_Windows_Linux_360 {
 ...
 protected:
  static RNS2SendResult Send_Windows_Linux_360NoVDP(
      RNS2Socket rns2Socket, RNS2_SendParameters *sendParameters,
      const char *file, unsigned int line);
};
#endif
...
class RAK_DLL_EXPORT SocketLayerOverride {
 public:
  ...
  virtual int RakNetSendTo(const char *data, int length,
  ...
  virtual int RakNetRecvFrom(char dataOut[MAXIMUM_MTU_SIZE],
